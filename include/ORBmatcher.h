...
namespace ORB_SLAM3 {
    ...
    public:
        ...
        // Matching for segment region
        void MFSearchForSegmentregion(Frame &F1, Frame &F2, vector<cv::Point2f> &vbPrevMatched, vector<float> &vnMatches12, vector<float> &vnoutMatches12, int windowSize);
        // Matching for segment region
        void MFSearchForSegmentregiondyna(Frame &F1, Frame &F2, vector<cv::Point2f> &vbPrevMatched, vector<float> &vnMatches12, vector<float> &vnoutMatches12, int windowSize);
